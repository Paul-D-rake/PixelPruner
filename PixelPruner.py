...
class PixelPruner:
    def __init__(self, master):
        ...
        self.size_dropdown = ttk.Combobox(control_frame, textvariable=self.size_var, state="readonly", values=["512x512", "768x768", "1024x1024", "1024x1536", "1024x2048", "1024x1792", "2048x2048"])
